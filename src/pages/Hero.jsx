    ...
    <>
      <section className="min-h-screen flex flex-col items-center justify-center text-center px-6">
        <div className="max-w-3xl">
          <img src="/image.png" alt="Vitor Bugallos" className="w-36 h-36 rounded-full mx-auto object-cover shadow-lg mb-6 fade-up shadow-md transition-shadow duration-300 hover:shadow-blue-500 hover:shadow-lg" />
